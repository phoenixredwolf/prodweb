                    ...
                    Column(
                        ...
                        Column(
                            ...
                            P(
                                ...
                                Text("Our risk assessments are tailored to your specific industry, taking into account industry-specific threats and regulations, ensuring relevance and accuracy.")
                            }
                    ...
                    Column(
                        ...
                        Column(
                            ...
                            H5(
                                attrs = ServiceH5Style.toModifier().fillMaxWidth().toAttrs(),
                                content = {
                                    Text("Navigating Compliance Requirements")
                                }
                            )
                            P(
                                attrs = Modifier
                                ...
                                Text("We ensure that your risk management practices align with industry-specific regulations and compliance standards, helping you avoid legal complications.")
                            }
                        }
                    }
                    Column(
                        ...
                        Column(
                            ...
                            P(
                                ...
                                Text("Cybersecurity is a core focus. We evaluate and enhance your cybersecurity measures to protect critical data from breaches and theft.")
                            }
                    ...
                    Column(
                        ...
                        Column(
                            ...
                            P(
                                ...
                                Text("Our risk assessment process involves meticulous data collection, thorough analysis, and detailed reporting, ensuring you receive a holistic view of your risk landscape.")
                            }
                    ...
                    Column(
                        ...
                        Column(
                            ...
                            P(
                                ...
                                Text("Our risk reports provide you with actionable insights, allowing you to make informed decisions and prioritize risk mitigation strategies effectively.")
                            }
                        }
                    }
                }
            ...
            Column(
                ...
                Row(
                    ...
                    H5(
                        ...
                        content = { Text("Why Choose Our Risk Assessment Services? The Advantages Are Clear:") }
                    )
                }
                Ul(
                    ...
                    Li {
                        Span(
                            attrs = Modifier
                                ...
                                .toAttrs(),
                            content = { Text("Comprehensive Analysis: ") }
                        )
                        Text("Our team conducts in-depth assessments to identify risks comprehensively, leaving no stone unturned.")
                    }
                    Li {
                        Span(
                            attrs = Modifier
                                .fontWeight(FontWeight.SemiBold)
                                .toAttrs(),
                            content = { Text("Tailored Solutions: ") }
                        )
                        Text("We understand that every business is unique. Our solutions are customized to address your specific risk landscape.")
                    }
                    Li {
                        Span(
                            attrs = Modifier
                                .fontWeight(FontWeight.SemiBold)
                                .toAttrs(),
                            content = { Text("Threat Mitigation: ") }
                        )
                        Text("Beyond identifying risks, we provide strategies to mitigate these risks, ensuring a proactive approach to security.")
                    }
                    Li {
                        Span(
                            attrs = Modifier
                        ...
                        Text("Your data is critical. We prioritize data protection in our risk assessment process.")
                    }
                }
            }
        }
            ...
            Column(
                ...
                Row(
                    ...
                    H5(
                        attrs = ServiceH5Style.toModifier().toAttrs(),
                        content = {
                            Text("Our Risk Assessment Services Cover:")
                        }
                    )
                }
                Ul(
                    ...
                    Li {
                        Span(
                            attrs = Modifier
                                .fontWeight(FontWeight.SemiBold)
                                .toAttrs(),
                            content = { Text("Vulnerability Assessment: ") }
                        )
                        Text("We identify vulnerabilities in your systems and operations, pinpointing areas that need attention.")
                    }
                    Li {
                        Span(
                            attrs = Modifier
                                .fontWeight(FontWeight.SemiBold)
                                .toAttrs(),
                            content = { Text("Threat Analysis: ") }
                        )
                        Text("Our experts assess potential threats, whether they originate from internal or external sources.")
                    }
                    Li {
                        Span(
                            attrs = Modifier
                                .fontWeight(FontWeight.SemiBold)
                                .toAttrs(),
                            content = { Text("Compliance Evaluation: ") }
                        )
                        Text("We evaluate your compliance with industry regulations and standards, ensuring legal adherence.")
                    }
                    Li {
                        Span(
                            attrs = Modifier
                                .fontWeight(FontWeight.SemiBold)
                                .toAttrs(),
                            content = { Text("Risk Mitigation Strategies: ") }
                        )
                        Text("We provide actionable strategies to reduce or eliminate identified risks.")
                    }
                }
            }
        }
